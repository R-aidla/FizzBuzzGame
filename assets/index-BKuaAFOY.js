(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const h of i.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&o(h)}).observe(document,{childList:!0,subtree:!0});function r(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=r(n);fetch(n.href,i)}})();function T(e){let t=!1;const r=n=>{t=n,g(e,t)},o=()=>{y||(t=!t,g(e,t))};e.addEventListener("click",()=>o()),r(!1)}function x(e){const t=()=>{y||(M(),Z())};e.addEventListener("click",()=>t())}function g(e,t){t?e.classList.add("selected"):e.classList.remove("selected")}const H="/tutorial/Example1.png",k="/tutorial/Example2.png";function I(e,t){document.querySelector("#app").innerHTML=`
  ...
  `,document.querySelector("#startButton").addEventListener("click",()=>S()),document.querySelector("#tutorialButton").addEventListener("click",()=>q())}function E(e){document.querySelector("#app").innerHTML=`
  <div class="titleBox">
  ...
  <div class="hybridBox">
  <div class="imgBox">
  <img src=${H} alt="Showing UI" />
  <img src=${k} alt="Incorrect answer" />
  </div>
  <div class="textBox">
  ...
  `,document.querySelector("#startButton").addEventListener("click",()=>S())}let B=60,D=1,l,d=[{word:"fizz",divisibleBy:3,button:void 0},{word:"buzz",divisibleBy:5,button:void 0},{word:"bizz",divisibleBy:7,button:void 0},{word:"fuzz",divisibleBy:9,button:void 0}],u=0,b=0,m=0,a=0,p=Number(localStorage.getItem("highScore"));var y=!1;let c=0;var f;let s=0;function v(e,t){for(let r=0+t;r<e+t;r++){const o=document.createElement("button");o.id=`${d[r].word}Button`,o.type="button",o.classList.add("unselectable"),o.style.margin="4px",o.textContent=d[r].word.toUpperCase(),d[r].button=o,T(o),document.querySelector("#buttonCard").appendChild(o)}}function U(){d=[{word:"fizz",divisibleBy:3,button:void 0},{word:"buzz",divisibleBy:5,button:void 0},{word:"bizz",divisibleBy:7,button:void 0},{word:"fuzz",divisibleBy:9,button:void 0}],s=0,b=0,a=0,m=0,u=0,l=D}let L;E(p);function S(){U(),document.querySelector("#app").innerHTML=`
  <div>
